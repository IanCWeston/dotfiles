return {
  ...
  dependencies = {
    ...
    -- Snippets
    { "L3MON4D3/LuaSnip" },
    { "rafamadriz/friendly-snippets" }, -- General Snippets
    { "bammab/vscode-snippets-for-ansible" }, -- Ansible Snippets
  },
  config = function()
...
-- TODO: Split out Null-ls into own plugin for lazy loading
